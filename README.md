...
<ul>
	...
	<li>[--merge-depth] ou [-d] <p>Define a profundidade da recursão do merge sort. Além disso, o número subvetores em que os dados são divididos. Veja que esse valor não é definido de forma direta, mas sim por meio de uma potência de base 2 (2^-d). O valor 5 é utilizado por padrão, caso esta opção não seja definida. Desta forma, há por padrão 32 subvetores (2^5).</p></li>
